    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">大学奖学金评定管理系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <!--
                            <el-form-item label="学号" class="input" v-if="tableName=='laoshi'">
                                <el-input v-model="ruleForm.laoshiUuidNumber" autocomplete="off" placeholder="学号"  />
                           </el-form-item>
                        -->
