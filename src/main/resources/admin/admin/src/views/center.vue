<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='laoshi'"  label='学号' prop="laoshiUuidNumber">
               <el-input v-model="ruleForm.laoshiUuidNumber"disabled="true"   placeholder='学号' clearable></el-input>
           </el-form-item>
         </el-col>
         <el-col :span="12">
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='xuesheng'"  label='学号' prop="xueshengUuidNumber">
               <el-input v-model="ruleForm.xueshengUuidNumber"disabled="true"   placeholder='学号' clearable></el-input>
           </el-form-item>
         </el-col>
         <el-col :span="12">
